      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-8">
          {pricing.map((price, index) => (
            <Card
              key={index}
              className={`w-full md:w-80 text-gray-700 dark:text-gray-300 ${
                price.plan === "PRO" ? "border-[#f3aa1d]" : ""
              } bg-white dark:bg-gray-800`}
            >
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-4 text-center text-gray-700 dark:text-gray-200">
                  {price.plan}
                </h3>
                <p className="text-4xl font-bold text-center mb-6 text-gray-700 dark:text-gray-200">
                  {price.price}
                ...
                <Button
                  className={`w-full bg-[#195276] text-white hover:bg-[#195276]/90 ${
                    price.plan === "PRO"
                      ? "bg-[#f3aa1d] dark:bg-[#f3aa1d] dark:text-[#f7f7f7] text-[#f7f7f7] hover:bg-[#F3AA1D]/90"
                      : ""
                  }`}
                >
                  {price.buttonText}
